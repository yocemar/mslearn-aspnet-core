...
# please open an issue on https:/github.com/yocemar/mslearn-aspnet-core.
#
...
declare initScript=https://raw.githubusercontent.com/yocemar/mslearn-aspnet-core/$gitBranch/infrastructure/scripts/initenvironment.sh
